...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        expect(firstRepositoryItem).toHaveTextContent(calculatorCount(repositories.edges[0].node.forksCount));
        expect(secondRepositoryItem).toHaveTextContent(calculatorCount(repositories.edges[1].node.forksCount));
      });
    });
  });